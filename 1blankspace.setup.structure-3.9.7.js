	...
	summary:	function ()
				{
					...
					else
					{
						...
						$vq.add('<tr><td>' +
										'<span style="width:60px;" id="ns1blankspaceSummaryStructureExport" class="ns1blankspaceAction">Export</span>' +
										'</td></tr>');
										
						$vq.add('</table>');					
						
						$vq.render('#ns1blankspaceSummaryColumn2');

						$('#ns1blankspaceSummaryStructureExport').button(
						{
							label: "Export"
						})
						.click(function()
						{
							 ns1blankspace.setup.space.export.structures.init({structure: ns1blankspace.objectContext});
						});
					}	
				},
					...
					edit:		function (oParam, oResponse)
								{
									...
									if (oResponse == undefined)
									{
										...
										aHTML.push('<tr class="ns1blankspaceCaption">' +
														'<td class="ns1blankspaceCaption">' +
														'Alias&nbsp;<div class="ns1blankspaceSubNote">(must start with "_" and be unique)</div>' +
														'</td></tr>' +
														'<tr class="ns1blankspaceTextMulti">' +
														'<td class="ns1blankspaceTextMulti">' +
									...
									{	
										if (sID != undefined)
										{
											...
											oSearch.addField( 'backgroundcolour,caption,category,categorytext,datatype,datatypetext,description,displayorder,' +
																	'hint,notes,notestype,notestypetext,reference,structure,structuretext,textcolour,title,alias,object');
											oSearch.addFilter('id', 'EQUAL_TO', sID);
									...
									show:		function (oParam, oResponse)
												{
													...
													{	
														...
														aHTML.push('<td class="ns1blankspaceHeaderCaption" style="text-align:right"><span id="ns1blankspaceElementOptionAdd"></span></td>');
														aHTML.push('</tr>');
