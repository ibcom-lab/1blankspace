					...
					show: 		function(oParam, oResponse)
								{
									...
									$vq.add('<tr class="ns1blankspaceContainer">' +
										...
										{
											$vq.add('<div class="btn-group" role="group" data-toggle="buttons" id="ns1blankspaceAccessType" style="margin-left:0px; margin-right:3px; margin-bottom:5px; width:360px; float:left;">'
															, {queue: 'access'});

												$vq.add('<label class="btn btn-default btn-sm active" id="ns1blankspaceAccessType-methods">' +
																	'<input type="radio" name="radioAccessType" data-1blankspace="ignore" />Methods' +
																	'</label>' +
															'<label class="btn btn-default btn-sm" id="ns1blankspaceAccessType-parameters">' +
																	'<input type="radio" name="radioAccessType" data-1blankspace="ignore" />Properties' +
																	'</label>' +
															'<label class="btn btn-default btn-sm" id="ns1blankspaceAccessType-data">' +
																	'<input type="radio" name="radioAccessType" data-1blankspace="ignore" />Data' +
																	'</label>', {queue: 'access'});

											$vq.add('</div>', {queue: 'access'});
										}
										else
										{
									...
									$('#ns1blankspaceAccessType ' + sSelect).click(function()
									{
									...
									show: 		function (oParam, oResponse)
												{
													if (oResponse == undefined)
													{
														...
														$vq.add('<tr><td>' +
																		'<span style="width:60px;" id="ns1blankspaceUserRoleAccessEdit" class="ns1blankspaceAction">Edit</span>' +
																		'</td></tr>');
														...
														$vq.add('<tr><td style="padding-top:16px;">' +
																		'<span style="width:60px;" id="ns1blankspaceUserRoleAccessExport" class="ns1blankspaceAction">Edit</span>' +
																		'</td></tr>');
														...
														$('#ns1blankspaceUserRoleAccessExport').button(
														{
															label: "Export"
														})
														.click(function()
													...
													else
													{
														...
														{		
															...
															ns1blankspace.render.page.show(
															{
																...
																headerRow: true,
																functionOnNewPage: ns1blankspace.setup.userRole.access.methods.bind
															});
														}
													}
												},		
									...
									bind: 	function ()
												{
													...
													.click(function()
													{
														ns1blankspace.remove(
														{
															...
															method: 'SETUP_ROLE_METHOD_ACCESS_MANAGE',
															ifNoneMessage: 'No access set up.'
														});
													})
													.css('width', '15px')
													.css('height', '17px');
									...
									edit: 	function (oParam, oResponse)
												{
													...
													else if (iStep == 5)
													{
														...
														else
														{
															...
															$('[name="radioNeedGUID"][value="N"]').attr('checked', true);
														}
													}
												}
								},
									...
									edit: 		function (oParam, oResponse)
												{
													...
													if (oResponse == undefined)
													{
														...
														$vq.add('<tr><td class="ns1blankspaceSubNote" style="padding-top:12px;">Property must be of data type <strong>Numeric</strong>.</td></tr>');
