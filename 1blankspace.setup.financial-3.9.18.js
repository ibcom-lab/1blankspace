	...
	home:		function (oParam, oResponse)
				{
					...
					*/
					...
					{
						ns1blankspace.show({selector: '#ns1blankspaceMainPaymentAccount', refresh: true});
						ns1blankspace.setup.financial.paymentAccounts();
					});
					
					$('#ns1blankspaceControlFinancialAccount').click(function(event)
					{
						ns1blankspace.show({selector: '#ns1blankspaceMainFinancialAccount', refresh: true});
				...
				function (oParam, oResponse)
				{
					...
					{	
						...
						if (sID != undefined)
						{
							...
							oSearch.method = 'SETUP_FINANCIAL_FUNDS_TRANSFER_ACCOUNT_SEARCH';
							oSearch.addField('title,provider,providertext,status,statustext,takepayment,makepayment,urlcancel,urlsuccess,provideraccountkey,' +
												'apikey,apilogon,bankaccount,bankaccounttext');
							oSearch.addFilter('id', 'EQUAL_TO', sID);
							oSearch.getResults(function(data)
							{
								$.extend(true, oParam, {step: 3});
					...
					{
						var oObjectContext = oResponse.data.rows[0];
                        if (oObjectContext.takepayment == '') {oObjectContext.takepayment = 'N'}
                        if (oObjectContext.makepayment == '') {oObjectContext.makepayment = 'N'}
					...
					show:		function (oParam, oResponse)
								{
									...
									if (iStep == 1)
									{
										...
										else
										{
											...
											else
											{
                                                ...
                                                aHTML.push('<span style="width:60px; margin-top:10px;" id="ns1blankspaceFinancialAccountsImport" class="ns1blankspaceAction">Import</span>');					
                                                ...
                                                .click(function()
                                                {
                                                    ns1blankspace.setup.space.initialise.init({type: 5, xhtmlElementID: 'ns1blankspaceMain'})
                                                });
											}
										}	
									}	
									...
									else if (iStep == 4)
									{
										...
										else
										{
                                            ...
                                            $('[name="radioOtherExpense"][value="1"]').attr('checked', true);
				...
				function ()
				{
					...
					if ($('#ns1blankspaceMainFinancialAccountDefault').attr('data-loading') == '1')
					{
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
                                        ...
                                        '<div class="ns1blankspaceSubNote">' + ns1blankspace.option.taxVATCaption + ' Collected</div>' +
										'</td></tr>' +
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										'<td class="ns1blankspaceCaption">' +
                                        '<div>Tax Credits</div>' +
                                        '<div class="ns1blankspaceSubNote">' + ns1blankspace.option.taxVATCaption + ' Paid</div>' +
										'</td></tr>' +
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
                        ...
                        aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
										'<input id="ns1blankspaceFinancialAccountPayrollFinancialAccountAllowance" class="ns1blankspaceSelect"' +
											' data-method="SETUP_FINANCIAL_ACCOUNT_SEARCH"' +
											' data-columns="title">' +
										'</td></tr>');
                        ...
                        aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
										'<input id="ns1blankspaceFinancialAccountPayrollFinancialAccountSalary" class="ns1blankspaceSelect"' +
											' data-method="SETUP_FINANCIAL_ACCOUNT_SEARCH"' +
											' data-columns="title">' +
										'</td></tr>');
                        ...
                        aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
										'<input id="ns1blankspaceFinancialAccountPayrollFinancialAccountSuperannuation" class="ns1blankspaceSelect"' +
											' data-method="SETUP_FINANCIAL_ACCOUNT_SEARCH"' +
											' data-columns="title">' +
										'</td></tr>');
						...
						if (ns1blankspace.objectContextData != undefined)
						{
                            ...
                            $('#ns1blankspaceFinancialAccountPayrollFinancialAccountAllowance').val(ns1blankspace.objectContextData.payrollfinancialaccountallowancetext);
							$('#ns1blankspaceFinancialAccountPayrollFinancialAccountAllowance').attr("data-id", ns1blankspace.objectContextData.payrollfinancialaccountallowance);
                            $('#ns1blankspaceFinancialAccountPayrollFinancialAccountSalary').val(ns1blankspace.objectContextData.payrollfinancialaccountsalarytext);
							$('#ns1blankspaceFinancialAccountPayrollFinancialAccountSalary').attr("data-id", ns1blankspace.objectContextData.payrollfinancialaccountsalary);
                            $('#ns1blankspaceFinancialAccountPayrollFinancialAccountSuperannuation').val(ns1blankspace.objectContextData.payrollfinancialaccountsuperannuationtext);
							$('#ns1blankspaceFinancialAccountPayrollFinancialAccountSuperannuation').attr("data-id", ns1blankspace.objectContextData.payrollfinancialaccountsuperannuation);
                        }
					}	
				},
					...
					show: 	function (oParam, oResponse)
								{
									...
									if (oResponse == undefined)
									{
										if ($('#ns1blankspaceMainPayroll').attr('data-loading') == '1')
										{
                                            ...
                                            aHTML.push( '<tr class="ns1blankspace">' +
                                                            '<td class="ns1blankspaceCaption">' +
                                                            'On completion of the payroll period create financial items' +
                                                            '</td></tr>' +
                                                            '<tr class="ns1blankspace">' +
                                                            '<td class="ns1blankspaceRadio">' +
                                                            '<input type="radio" id="radioPayrollFinancialsCreateExpensesN" name="radioPayrollFinancialsCreateExpenses" value="N"/>No' +
                                                            '<br /><input type="radio" id="radioPayrollFinancialsCreateExpensesY" name="radioPayrollFinancialsCreateExpenses" value="Y"/>Yes (recommended)' +
                                                            '</td></tr>');
											...
											if (ns1blankspace.objectContextData != undefined)
											{
												...
												$('[name="radioPayrollFinancialsPayments"][value="' + ns1blankspace.objectContextData.payrollsetsalaryexpensestopaid + '"]').attr('checked', true);
                                                $('[name="radioPayrollFinancialsCreateExpenses"][value="' + ns1blankspace.objectContextData.payrollcreateexpenses + '"]').attr('checked', true);
									...
									init:		function (oParam)
												{
													...
													{	
														...
														oSearch.addField('includeinallowancesnontaxable,includeinallowancestaxable,includeindeductions,includeingrosssalary,' +
																			...
																			'includeinsalarysacrificesuper,includeinstandardhours,includeinsuper,includeintaxadjustments,notes,title,fixed,reportingcode');
														oSearch.rows = 100;
														oSearch.sort('title', 'asc');
														oSearch.getResults(function(oResponse)
														{
									...
									edit: 		function (oParam)
												{
													...
													{	
                                                        ...
                                                        if (oLineType.reportingcode != '')
                                                        {
                                                            $vq.add('<tr><td class="ns1blankspaceCaption" style="padding-top:8px;">' +
																		'Reporting Code' +
																		'</td></tr>' +
                                                                        '<tr><td class="ns1blankspaceSummary">' + oLineType.reportingcode + '</td></tr>'
                                                                        , {queue: 'type-edit'});
                                                        }

                                                        if (oLineType.includeinleavetypetext != '')
                                                        {
                                                            $vq.add('<tr><td class="ns1blankspaceCaption" style="padding-top:8px;">' +
																		'Leave Type' +
																		'</td></tr>' +
                                                                        '<tr><td class="ns1blankspaceSummary">' + oLineType.includeinleavetypetext + '</td></tr>'
                                                                        , {queue: 'type-edit'});
                                                        }
													}
													else
													{
                                                        ...
                                                        $vq.add('<tr><td class="ns1blankspaceCaption">' +
																		...
																		'<tr class="ns1blankspace">' +
																		'<td class="ns1blankspaceText">' +
																		'<input id="ns1blankspaceSetupPayrollTypeReportingCode" class="ns1blankspaceText" style="width:50%;">' +
																		'</td></tr>' +
																		'</tr>', {queue: 'type-edit'});
                                                        ...
                                                        $vq.add('<tr class="ns1blankspaceCaption">' +
                                                                        ...
                                                                        '<tr class="ns1blankspace">' +
                                                                        '<td class="ns1blankspaceSelect">' +
                                                                        '<input id="ns1blankspaceSetupPayrollTypeLeaveType" class="ns1blankspaceSelect"' +
                                                                            ' data-method="SETUP_FINANCIAL_PAYROLL_LEAVE_TYPE_SEARCH"' +
                                                                            ' data-columns="title">' +
                                                                        '</td></tr>', {queue: 'type-edit'});

														$vq.init('<table class="ns1blankspaceColumn2"><tr><td>' +
																	'<span id="ns1blankspaceSetupPayrollTypeEditSave" class="ns1blankspaceAction" style="width:65px;">Save</span></td>' +
                                                        ...
                                                        $('#ns1blankspaceSetupPayrollTypeEditSave').button()
														.click(function()
														{
															
                                                            var oData = {id: oLineType.id}

                                                            oData.title = $('#ns1blankspaceSetupPayrollTypeTitle').val();
                                                            oData.reportingcode = $('#ns1blankspaceSetupPayrollTypeReportingCode').val();

                                                            if ($('#ns1blankspaceSetupPayrollTypeLeaveType').attr('data-id') != '' && $('#ns1blankspaceSetupPayrollTypeLeaveType').attr('data-id') != undefined)
                                                            {
                                                                oData.includeinleavetype = ns1blankspace.util.fs($('#ns1blankspaceSetupPayrollTypeLeaveType').attr('data-id'));
                                                            }
                                                    ...
                                                    $('#ns1blankspaceSetupPayrollTypeReportingCode').val(oLineType.reportingcode);

                                                    $('#ns1blankspaceSetupPayrollTypeLeaveType').attr('data-id', oLineType.includeinleavetype);
											        $('#ns1blankspaceSetupPayrollTypeLeaveType').val(oLineType.includeinleavetypetext);
					...
					send:		function ()
								{
									...
									if ($('#ns1blankspaceMainFinancialAccountDefault').html() != '')
									{
                                        ...
                                        sData += '&payrollfinancialaccountallowance=' + ns1blankspace.util.fs($('#ns1blankspaceFinancialAccountPayrollFinancialAccountAllowance').attr('data-id'));
                                        sData += '&payrollfinancialaccountsalary=' + ns1blankspace.util.fs($('#ns1blankspaceFinancialAccountPayrollFinancialAccountSalary').attr('data-id'));
                                        sData += '&payrollfinancialaccountsuperannuation=' + ns1blankspace.util.fs($('#ns1blankspaceFinancialAccountPayrollFinancialAccountSuperannuation').attr('data-id'));
									};
									...
									if ($('#ns1blankspaceMainPayroll').html() != '')
									{
                                        ...
                                        sData += '&payrollcreateexpenses=' + ns1blankspace.util.fs($('input[name="radioPayrollFinancialsCreateExpenses"]:checked').val());
                                        sData += '&payrollsetsalaryexpensestopaid=' + ns1blankspace.util.fs($('input[name="radioPayrollFinancialsPayments"]:checked').val());
