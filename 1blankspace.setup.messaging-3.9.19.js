	...
	home: 	function (oParam, oResponse)
				{
					if (oResponse == undefined)
					{
						...
						oSearch.addField('email,usertext,verification,accountname,smtpaccountname,typetext,notes');
						if (ns1blankspace.option.messagingIncludePOP)
						{
							oSearch.addFilter('type', 'IN_LIST', '2,5');
						}
						else
						{
						...
						else
						{
							...
							$.each(oResponse.data.rows, function()
							{
								...
								aHTML.push('<td id="ns1blankspaceMostLikely_title-' + this.id + 
														...
														(this.email?this.email:(this.accountname?this.accountname:(this.smtpaccountname?this.smtpaccountname:this.notes))));

								if (ns1blankspace.option.messagingIncludePOP)
								{
									aHTML.push('<span class="ns1blankspaceSubNote"> ' + this.typetext + '</span>')
								}
	...
	details:	function ()
				{
					...
					if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
					{
                        ...
                        if (ns1blankspace.option.messagingIncludePOP)
						{
							aHTML.push('<br /><input type="radio" id="radioType2" name="radioType" value="2"/>POP')
						}
                        ...
                        aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceRadio">' +
										'<input type="radio" id="radioAuthType0" name="radioAuthType" value="0"/>Username/Password' +
                                        '<br /><input type="radio" id="radioAuthType3" name="radioAuthType" value="3"/>OAuth2')
						...
						if (ns1blankspace.objectContextData != undefined)
						{
							...
							$('[name="radioAuthType"][value="' + ns1blankspace.objectContextData.authtype + '"]').attr('checked', true);
						}
						else
						{
							...
							$('[name="radioAuthType"][value="0"]').attr('checked', true);
						}
					}	
				},
					...
					send:		function()
								{
									...
									if ($('#ns1blankspaceMainDetails').html() != '')
									{
										...
										sData += '&authtype=' + ns1blankspace.util.fs($('input[name="radioAuthType"]:checked').val());
									...
									var sURL = ns1blankspace.util.endpointURI('SETUP_MESSAGING_ACCOUNT_MANAGE');

									if (ns1blankspace.option.messagingIncludePOP && $('input[name="radioType"]:checked').val() == '2')
									{
										sURL = '/ondemand/setup/?method=SETUP_MESSAGING_ACCOUNT_MANAGE'
									}	
