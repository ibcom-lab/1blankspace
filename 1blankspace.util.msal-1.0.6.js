    ...
    [
        {
            ...
            apiURI: 'https://sandbox-api.singletouch.com.au/api/STPEvent2020',
            webAPI: 'https://sandbox-api.singletouch.com.au/api/STPEvent2020',
        ...
        },
        {
            ...
            auth:
            {
                ...
                authority: 'https://singletouch.b2clogin.com/tfp/singletouch.onmicrosoft.com/b2c_1_singletouch',
                validateAuthority: false
            },
            cache:
            {
            ...
            apiURI: 'https://api.singletouch.com.au/api/STPEvent2020',
            webAPI: 'https://api.singletouch.com.au/api/STPEvent2020',
            tokenAcquired: function (oToken)
            {
                var sMSALUsername = '';
                var sMSALEmail = '';
                ...
                location.href = document.referrer + '/#/base64:' + window.btoa('financial.payroll/' + ns1blankspace.util.msal._param.context +
                         ',showTotals:true,msalUsername:' + sMSALUsername + ',msalEmail:' + sMSALEmail + ',msalAccessToken:' + oToken.accessToken)
            },
            atoproductid: '582695'
        }
