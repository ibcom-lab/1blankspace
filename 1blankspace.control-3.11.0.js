...
ns1blankspace.xhtml.loading = '<img class="ns1blankspaceLoading" id="ns1blankspaceLoading" src="/site/1903/1blankspace.loading.square.20.gif">';
ns1blankspace.xhtml.loadingSmall = '<img class="ns1blankspaceLoadingSmall" id="ns1blankspaceLoadingSmall" src="/site/1903/1blankspace.loading.square.10.gif">';
...
ns1blankspace.option = $.extend(true, ns1blankspace.option, 
{
	...
	helpURI: 'http://learn.entityos.cloud',
	taxVATCaption: 'GST',
	...
	pdfStyles: '<link rel=stylesheet href="/site/1903/1blankspace-3.0.7.css">',
	_messagingCheckURL: 'https://api.entityos.cloud',
...
{
	url: 'https://docs.entityos.cloud/paynow',
...
ns1blankspace.xhtml.templates.source =
{
	...
	payroll: '/site/1903/1blankspace.setup.financial.paysummary-1.0.2.html',
	payslip: '/site/1903/1blankspace.setup.financial.payslip-1.0.1.html',
...
{
	"background": 'url(/site/1903/entityos-app-org-bg.jpg)',
	  			...
	  			'<div class="navbar-header">' +
	      			'<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#ns1blankspace-navbar-collapse-1" aria-expanded="false">' +
				       	...
				       	'<span class="icon-bar"></span>' +
				        	'<span class="icon-bar"></span>' +
			      	'</button>' +
			      	'<a class="navbar-brand" style="padding-top: 10px; padding-left: 22px;" href="/"><img id="ns1blankspaceNavigationLogo" style="height:38px;" src="/site/1903/entityos-app-org-blue-green.png"></a>' +
			    '</div>' +
...
ns1blankspace.xhtml.headerLogon =
	  			...
	  			'<div class="navbar-header">' +
	      			'<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#ns1blankspace-navbar-collapse-1" aria-expanded="false">' +
				       	...
				       	'<span class="icon-bar"></span>' +
				        	'<span class="icon-bar"></span>' +
			      	'</button>' +
			      	'<a class="navbar-brand" style="padding-top: 18px; padding-left: 22px;" href="/"><img id="ns1blankspaceNavigationLogo" style="height:38px;" src="/site/1903/entityos-app-org-blue-green.png"></a>' +
			    '</div>' +
...
[
	...
	},
	{
		...
		source: '/site/1903/1blankspace.format-3.9.10.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.messaging.conversation-3.5.9.js'
	},
	{
		nameSpace: '1blankspace.messaging.imap',
		source: '/site/1903/1blankspace.messaging.imap-3.9.6.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.financial-3.9.18.js'
	},
	{
		nameSpace: '1blankspace.financial.bankAccount',
		source: '/site/1903/1blankspace.financial.bankaccount-3.9.23.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.financial.expense-2.1.7.js'
	},
	{
		nameSpace: '1blankspace.financial.receipt',
		source: '/site/1903/1blankspace.financial.receipt-3.8.2.js'
	},
	{
		nameSpace: '1blankspace.financial.payment',
		source: '/site/1903/1blankspace.financial.payment-3.9.4.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.financial.journal-3.6.0.js'
	},
	{
		nameSpace: '1blankspace.financial.tax',
		source: '/site/1903/1blankspace.financial.tax-3.7.3.js'
	},
	{
		nameSpace: '1blankspace.financial.payroll',
		source: '/site/1903/1blankspace.financial.payroll-3.9.16.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.setup.financial-3.9.18.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.setup.space-3.9.21.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.setup.user-3.6.9.js'
	},
	{
		nameSpace: '1blankspace.setup.userRole',
		source: '/site/1903/1blankspace.setup.userRole-3.6.7.js'
	},
	{
		nameSpace: '1blankspace.setup.website',
		source: '/site/1903/1blankspace.setup.website-3.9.17.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.supportissue-3.7.8.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.connect-3.6.6.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.util.financial-3.9.18.js'
	},
	{
		nameSpace: '1blankspace.admin.space',
		source: '/site/1903/1blankspace.admin.space-3.9.9.js'
	},
	{
		nameSpace: '1blankspace.admin.monitoring',
		source: '/site/1903/1blankspace.admin.monitoring-3.9.17.js'
	},
	{
		nameSpace: '1blankspace.admin.schema',
		source: '/site/1903/1blankspace.admin.schema-3.9.13.js'
	},
	{
	...
	},
	{
		...
		source: '/site/1903/1blankspace.util.financial.accounts-3.9.0.js'
	},
	{
		nameSpace: '1blankspace.util.financial.bankaccount',
		source: '/site/1903/1blankspace.util.financial.bankaccount-3.7.0.js'
	},
	{
...
[
	{
		title: 				'Standard',
		cssURI: 			'', 
		xhtmlHeaderLogo: 	'<img style="height:46px;" src="/site/1903/entityos-app-org-blue-green.png">',
		"default": 			true
	},
	{
		title: 				'Helping Hand',
			...
			{	
				...
				if (bShow)
				{
					aHTML.push('<table style="width:400px;">' + 
									...
									'<td id="ns1blankspaceHomeOptionClose" style="text-align:right;">' +
									'<span id="ns1blankspaceClose"></span></td>' +
									'</tr>' +
									'</table>');
				}
				...
				else
				{
					...
					if (oResponse.access_token != undefined)
					{
						if (ns1blankspace.authenticationUsingAccessToken == 3 || ns1blankspace.authenticationUsingAccessToken == undefined)
						{
					...
					aHTML.push('<tr><td style="padding-top: 12px;"><a href="http://mydigitalstructure.com/gettingstarted_authentication" target="_blank">More on authentication...</a></td></tr>');
					...
					if (confirm('Are you sure?'))
					{
						$.ajax(
						{
							...
							success: function(data)
							{
								...
								{
									ns1blankspace.status.error('<p>You do not have the rights to create a token.</p><p>Please contact your system administrator.</p>')
								}
							}
						})
					}		
							...
							$.ajax(
							{
								...
								success: function(data)
								{
									...
									{	
										...
										ns1blankspace.spaceUser = ns1blankspace.user.id;
					...
					$.ajax(
					{
						...
						success: function(oResponse)
						{
							...
							{	
								...
								ns1blankspace.spaceUser = oResponse.TargetUser;
								ns1blankspace.financial.data = undefined;
								ns1blankspace.financial.initStatus = undefined;
								ns1blankspace.extend.structure = undefined;
								$('#ns1blankspaceSpaceText').html(ns1blankspace.spaceText);
...
ns1blankspace.attachments = 
{
	...
	{ 
		show: function (oParam)
		{
			...
			if (!bBorders) {bBorders = (aAttachmentTypes.length > 0)}
				
			aHTML.push('<table class="' + (bBorders?'table':'') + '">');

			if (aAttachmentTypes.length > 0)
			{
				aHTML.push('<tr><th class="ns1blankspaceHeaderCaption">File</th><th class="ns1blankspaceHeaderCaption">Type</th>');
			}
			...
			for (var i = 0; i < iMaxFiles; i++) 	
			{
				...
				aHTML.push('<input class="ns1blankspaceUpload" type="file" name="file' + i + '" id="oFile' + i + '"' +
				...
				if (aAttachmentTypes.length > 0)
				{
					...
					aHTML.push('<select class="form-control input-sm ns1blankspaceAttachmentType">');
			...
			aHTML.push('<div id="ns1blankspaceUploadStatus" class="ns1blankspaceUpload" style="margin-left:8px; margin-top:20px; font-size:0.875em;"></div>')
