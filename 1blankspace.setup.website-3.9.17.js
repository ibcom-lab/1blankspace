					...
					send: 		function (sXHTMLElementID, oParam)
								{
									...
									if (sSearchContext != undefined && iSource != ns1blankspace.data.searchSource.browse)
									{
										...
										oSearch.addField('bodytag,cancreatespace,columns,cssattachment,cssattachmenttext,default,developeremail,documenttype,email,' +
															...
															'identityproviderurl,samlserviceprovidercertificate,useraccesstype,useraccesstypetext,createspacenotificationtotype,createspacenotificationtotypetext,' + 
                                                            'createspaceverificationnotificationtype,createspaceverificationnotificationtypetext');
	...
	details: 	function ()
				{
					...
					if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
					{
                        ...
                        aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<input type="radio" id="radioUserAccessType1" name="radioUserAccessType" value="1"/>Only Users In This Space' +
										'<br /><input type="radio" id="radioAccessType2" name="radioUserAccessType" value="2"/>' +
												'Any User' +
										'</td></tr>');
						...
						if (ns1blankspace.objectContextData != undefined)
						{
                            ...
                            $('[name="radioUserAccessType"][value="' + ns1blankspace.objectContextData.useraccesstype + '"]').attr('checked', true);
						}
						else
						{
	...
	advanced:	function ()
				{
					if ($('#ns1blankspaceMainAdvanced').attr('data-loading') == '1')
					{
						...
						if (ns1blankspace.option.canCreateSpaces && ns1blankspace.user.super)
						{				
                            ...
                            aHTML.push('<tr class="ns1blankspaceCaption">' +
                                            '<td class="ns1blankspaceCaption">' +
                                            'Send Space Creation Verification Code As' +
                                            '</td></tr>' +
                                            '<tr class="ns1blankspace">' +
                                            '<td class="ns1blankspaceRadio">' +
                                            '<input type="radio" id="radioCreateSpaceVerificationNotificationType1" name="radioCreateSpaceVerificationNotificationType" value="1"/>Email' +
                                            '<br /><input type="radio" id="radioCreateSpaceVerificationNotificationType2" name="radioCreateSpaceVerificationNotificationType" value="2"/>SMS' +
                                            '</td></tr>');

                            aHTML.push('<tr class="ns1blankspaceCaption">' +
                                            '<td class="ns1blankspaceCaption">' +
                                            'Send Space Created Notification To' +
                                            '</td></tr>' +
                                            '<tr class="ns1blankspace">' +
                                            '<td class="ns1blankspaceRadio">' +
                                            '<input type="radio" id="radioCreateSpaceNotificationToType1" name="radioCreateSpaceNotificationToType" value="1"/>User Email' +
                                            '<br /><input type="radio" id="radioCreateSpaceNotificationToType2" name="radioCreateSpaceNotificationToType" value="2"/>Site Email' +
                                            '</td></tr>');	
						}	
						...
						if (ns1blankspace.objectContextData != undefined)
						{
                            ...
                            $('[name="radioCreateSpaceNotificationToType"][value="' + ns1blankspace.objectContextData.createspacenotificationtotype + '"]').attr('checked', true);
                            $('[name="radioCreateSpaceVerificationNotificationType"][value="' + ns1blankspace.objectContextData.createspaceverificationnotificationtype + '"]').attr('checked', true);
						}
					}	
				},
					...
					edit:		function (oParam, oResponse)
								{
									...
									if (oResponse == undefined)
									{
										...
										aHTML.push('<tr><td id="ns1blankspaceWebsitePageNotes" style="padding-top:20px;"></td></tr>');
									...
									else
									{
										if (oResponse.data.rows.length != 0)
										{
											...
											if (oObjectContext.documenturl.indexOf('.') != -1)
											{
												$('#ns1blankspaceWebsitePageNotes').html(
													'<div class="ns1blankspaceSubNote" style="color:red">Note</div>' +
													'<div class="ns1blankspaceSubNote">As the URL contains <em>.' + oObjectContext.documenturl.split('.')[1] +
													'</em> the page will be returned as-is, with no website formatting applied to it.</div>');
											}
										}
										else
										{
					...
					add:		function (oParam, oResponse)
								{
									...
									if (oResponse == undefined)
									{
										...
										aHTML.push('<tr>' +
														'<td id="ns1blankspaceSetupWebsiteURLStatusContainer" style="margin-top:14px; width:90%;"></td></tr>');
										...
										.click(function() 
										{
											...
											$.ajax(
											{
												...
												success: function(data) {
													...
													{
														if (data.error.errornotes.indexOf('the URL must start with') != -1)
														{
	...
	saml: 	function ()
				{
					if ($('#ns1blankspaceMainSAML').attr('data-loading') == '1')
					{
						...
						aHTML.push('<tr><td class="ns1blankspaceHeaderCaption" style="padding-top:16px;">THIRD PARTY IDENTITY PROVIDER</td></tr>');
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceText">' +
										'<input id="ns1blankspaceIdentityProviderURL" class="ns1blankspaceText">' +
										'</td></tr>');	

						aHTML.push('<tr><td class="ns1blankspaceHeaderCaption" style="padding-top:16px;">SAML IDENTITY PROVIDER (IDP) METADATA</td></tr>');
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										'<td class="ns1blankspaceCaption">' +
										'Public Key / Certificate (X509 PEM)' +
										'</td></tr>' +
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceTextMulti">' +
                        ...
                        aHTML.push('<tr><td class="ns1blankspaceHeaderCaption" style="padding-top:16px;">SAML SERVICE PROVIDER (SP) METADATA</td></tr>');
                        ...
                        aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceTextMulti">' +
										'<textarea style="height: 350px;" rows="20" cols="80" id="ns1blankspaceSAMLServiceProviderCertificate" class="ns1blankspaceTextMultiLarge"></textarea>' +
										'</td></tr>');
						...
						if (ns1blankspace.objectContextData != undefined)
						{
							$('#ns1blankspaceIdentityProviderURL').val((ns1blankspace.objectContextData.identityproviderurl).formatXHTML());
							...
							$('#ns1blankspaceSAMLServiceProviderCertificate').val((ns1blankspace.objectContextData.samlserviceprovidercertificate).formatXHTML());
                        }
					}	
				},								
									...
									if (oResponse == undefined)
									{
										...
										{	
											...
											if ($('#ns1blankspaceMainDetails').html() != '')
											{
                                                ...
                                                oData.useraccesstype = $('input[name="radioUserAccessType"]:checked').val();
											}
											...
											if ($('#ns1blankspaceMainAdvanced').html() != '')
											{
                                                ...
                                                if (ns1blankspace.option.canCreateSpaces && ns1blankspace.user.super)
                                                {
                                                    ...
                                                    oData.createspacenotificationtotype = $('input[name="radioCreateSpaceNotificationToType"]:checked').val();
                                                    oData.createspaceverificationnotificationtype = $('input[name="radioCreateSpaceVerificationNotificationType"]:checked').val();
                                                }
											}
											...
											{
												oData.identityproviderurl = $('#ns1blankspaceIdentityProviderURL').val();
                                                ...
                                                oData.samlserviceprovidercertificate = $('#ns1blankspaceSAMLServiceProviderCertificate').val();
											}
