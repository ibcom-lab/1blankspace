					...
					send: 	function (sXHTMLElementId, oParam)
								{
									...
									{							
										...
										oSearch.addField( 'reference,tradename,legalname,phonenumber,faxnumber,email,industry,industrytext,' +
															...
															'notes,primarycontactperson,primarycontactpersontext,billtoperson,billtopersontext,modifieddate,' +
															'directdebitaccountname,directdebitaccountnumber,directdebitbank,directdebitbranchnumber,paymentterms,' +
															'relationshipmanager,relationshipmanagertext,' +
															'primarygroup,primarygrouptext,billtoperson,billtopersontext,paymentterms');
	...
	summary: 	function (oParam, oResponse)
				{
					...
					else
					{
						...
						else
						{
							...
							$('#ns1blankspaceFavourite').html('<div id="ns1blankspaceContactBusinessFavourite" style="font-size:0.75em; width:100px;"></div>');
	...
	details: 	function ()
				{
					...
					if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
					{
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
										'<input id="ns1blankspaceDetailsRelationshipManager" class="ns1blankspaceSelect" style="width:250px;"' +
											' data-method="CONTACT_PERSON_SEARCH"' +
											' data-columns="firstname-space-surname"' +
											' data-methodFilter="contactperson.user.id-IS_NOT_NULL">' +
										'</td></tr>');
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceSelect">' +
										'<input id="ns1blankspaceDetailsPrimaryGroup" class="ns1blankspaceSelect" style="width:250px;"' +
						...
						if (ns1blankspace.objectContextData != undefined)
						{
							...
							$('#ns1blankspaceDetailsRelationshipManager').val(ns1blankspace.objectContextData.relationshipmanagertext.formatXHTML());
							$('#ns1blankspaceDetailsRelationshipManager').attr('data-id', ns1blankspace.objectContextData.relationshipmanager);
							$('#ns1blankspaceDetailsPrimaryGroup').val(ns1blankspace.objectContextData.primarygrouptext.formatXHTML());
							$('#ns1blankspaceDetailsPrimaryGroup').attr('data-id', ns1blankspace.objectContextData.primarygroup);
						}
						...
						details: 
								{
									show:	function ()
											{	
												...
												aHTML.push('<table class="ns1blankspaceMain">' +
																	'<tr class="ns1blankspaceRow">' +
																	'<td class="ns1blankspaceColumn1Flexible">');
													...
													//invoices & - when update invoice namespace to respect it
													
													aHTML.push('<tr class="ns1blankspaceCaption">' +
																	'<td class="ns1blankspaceCaption">' +
																	'<div>Financials Contact Person</div>' +
																	'<div class="ns1blankspaceSubNote">for sending statements</div>' +
																	'</td></tr>' +
																	'<tr class="ns1blankspace">' +
																	'<td class="ns1blankspaceText">' +
																	'<input id="ns1blankspaceFinancialsDetailsBillToPerson" class="ns1blankspaceSelect"' +
																		' data-method="CONTACT_PERSON_SEARCH"' +
																		' data-columns="firstname-space-surname"' +
												...
												aHTML.push('</td><td style="width:250px;">');

												aHTML.push('<table><tr class="ns1blankspaceCaption">' +
																	'<td class="ns1blankspaceCaption">' +
																	'Payment Terms' +
																	'</td></tr>' +
																	'<tr class="ns1blankspace">' +
																	'<td class="ns1blankspaceRadio">' +
																	'<div><span style="padding-right:8px;"><input style="margin-top:2px; margin-right:2px;" type="radio" id="radioPaymentTerms1" name="radioPaymentTerms" value="1"/>Set on invoice</span>' +
																	'<div style="margin-top:4px;" class="ns1blankspaceSub">Days From Invoice Date</div>' +
																	'<div><span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms2" name="radioPaymentTerms" value="2"/>7</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms3" name="radioPaymentTerms" value="3"/>14</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms4" name="radioPaymentTerms" value="4"/>30</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms5" name="radioPaymentTerms" value="5"/>60</span>' +
																	'</div><div style="margin-top:4px;" class="ns1blankspaceSub">Days From End of Month</div>' +
																	'<div><span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" <input type="radio" id="radioPaymentTerms6" name="radioPaymentTerms" value="6"/>7</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms7" name="radioPaymentTerms" value="7"/>14</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms8" name="radioPaymentTerms" value="8"/>30</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms9" name="radioPaymentTerms" value="9"/>60</span>' +
																	'<span style="padding-right:8px;"><input style="margin-top:4px; margin-right:2px;" type="radio" id="radioPaymentTerms10" name="radioPaymentTerms" value="10"/>90</span>' +
																	'</div></td></tr></table>');
												...
												if (ns1blankspace.objectContextData != undefined)
												{
													...
													$('#ns1blankspaceFinancialsDetailsBillToPerson').attr('data-id', ns1blankspace.objectContextData.billtoperson);
													$('#ns1blankspaceFinancialsDetailsBillToPerson').val(ns1blankspace.objectContextData.billtopersontext);
													
													$('[name="radioPaymentTerms"][value="' + ns1blankspace.objectContextData.paymentterms + '"]').attr('checked', true);
												}
												else
												{
													$('[name="radioPaymentTerms"][value="1"]').attr('checked', true);
												}
											}	
								},
					...
					send: 	function ()
								{
									...
									if ($('#ns1blankspaceMainDetails').html() != '')
									{
										...
										sData += '&relationshipmanager=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsRelationshipManager').attr('data-id'));
										sData += '&primarygroup=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsPrimaryGroup').attr('data-id'));
									}
									...
									if ($('#ns1blankspaceMainFinancials').html() != '')
									{
										...
										sData += '&paymentterms=' + $('input[name="radioPaymentTerms"]:checked').val();
										sData += '&billtoperson=' + $('#ns1blankspaceFinancialsDetailsBillToPerson').attr('data-id');
									}	
					...
					process: 	function (oResponse)
								{
									if (oResponse.status == 'OK')
									{
										...
										ns1blankspace.contactBusiness.search.send('-' + ns1blankspace.objectContext)
									}
									else
									{
	...
	groups: 	{							
					...
					search: 	{
									...
									process: 	function (oParam, oResponse)
												{
													...
													if (oResponse == undefined)
													{
														...
														var oSearch = new AdvancedSearch();
														oSearch.method = 'CONTACT_BUSINESS_GROUP_SEARCH';
														oSearch.addField('contactbusiness,businessgroup.contactbusiness.tradename,businessgroup.contactbusiness.legalname,group,grouptext');
														oSearch.addFilter('group', 'EQUAL_TO', aXHTMLElementId[1]);
														oSearch.addFilter('businessgroup.contactbusiness.tradename', 'TEXT_IS_NOT_EMPTY');
														oSearch.addSummaryField('count(*) count')
													...
													else
													{
														...
														{		
															...
															aHTML.push('<tr class="ns1blankspaceCaption">' + 
																			'<td colspan=2 class="ns1blankspaceHeaderCaption">' + aXHTMLElementId[2] + 
																			' (' + oResponse.summary.count + ')</td>' +
																			'</tr>');
									...
									row: 		function (oRow)
												{
													var aHTML = [];
													var sName = oRow["businessgroup.contactbusiness.tradename"];
													if (sName == '') {sName = oRow["businessgroup.contactbusiness.legalname"]}
