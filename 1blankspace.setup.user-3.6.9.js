	...
	summary: function ()
				{
					...
					else
					{
						...
						if (ns1blankspace.objectContextData.guid != '')
						{
							aHTML.push('<tr><td class="ns1blankspaceSummaryCaption">User ID</td></tr>' +
										'<tr><td id="ns1blankspaceSummaryGUID" class="ns1blankspaceSummary">' +
										(ns1blankspace.objectContextData.guid) +
										'</td></tr>');
						}
	...
	network: 	{
					show:		function (oResponse)
								{	
									...
									if (ns1blankspace.objectContextData != undefined)
									{
										$('[name="radioSupportContact"][value="' + ns1blankspace.objectContextData.canacceptsupportissues + '"]').attr('checked', true);
										$('[name="radioConversations"][value="' + ns1blankspace.objectContextData.canbeaddedtoexternalconversations + '"]').attr('checked', true);
										$('[name="radioSwitch"][value="' + ns1blankspace.objectContextData.canswitchintootherspaces + '"]').attr('checked', true);
									}
									else
									{
					...
					process:	function (oParam)
								{
									...
									{
										sData += '&canacceptsupportissues=' + $('input[name="radioSupportContact"]:checked').val();
										sData += '&canbeaddedtoexternalconversations=' + $('input[name="radioConversations"]:checked').val();
										sData += '&canswitchintootherspaces=' + $('input[name="radioSwitch"]:checked').val();
									}
