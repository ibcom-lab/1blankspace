	...
	home:		function (oParam, oResponse)
				{
					...
					{	
						...
						aHTML.push('<tr><td><span id="ns1blankspaceAdminMonitoring" class="ns1blankspaceAction">' +
												'</span></td></tr>');

						aHTML.push('<tr><td><span id="ns1blankspaceAdminSchema" class="ns1blankspaceAction">' +
												'</span></td></tr>');
						...
						$('#ns1blankspaceAdminSchema').button(
						{
							text: true,
							label: 'Schema',
						})
						.click(function()
						{
							ns1blankspace.admin.schema.init()
						})
						.css('width', '100px');
										...
										{	
											if (this.spacetext != '')
											{
												...
												aHTML.push('<td class="ns1blankspaceSearch" id="registration-' +
																this.id + '">' +
																'<span id="registrationspace-' + this.id + '">' + this.spacetext + '</span>' +
                                                                '<span class="ns1blankspaceSubNote"> (' + this.space + ')</span>' +
                                                                '</td>');
					...
					if (ns1blankspace.objectContextData == undefined)
					{
						...
						else
						{
                            ...
                            /*
                                aHTML.push('<tr class="ns1blankspaceCaption">' +
											'<td class="ns1blankspaceCaption">' +
											'Verification Code (once received via SMS)' +
											'</td></tr>' +
											'<tr class="ns1blankspace">' +
											'<td class="ns1blankspaceText">' +
											'<input id="ns1blankspaceDetailsVerifyCode" class="ns1blankspaceText">' +
											'</td></tr>');
                            */
					...
					else
					{
						...
						{	
							...
							aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<input type="radio" id="radioStatus3" name="radioStatus" value="3"/>Trial<br />' +
										'<input type="radio" id="radioStatus7" name="radioStatus" value="7"/>Disabled<br />' +
                                        '<input type="radio" id="radioStatus8" name="radioStatus" value="8"/>Disabled (To Be Terminated)<br />' +
                                        '<input disabled="true" type="radio" id="radioStatus12" name="radioStatus" value="12"/>' +
                                            '<span class="ns1blankspaceSub">Disabled (Terminated)</span><br />' +
										'<input disabled="true" type="radio" id="radioStatus2" name="radioStatus" value="2"/>' +
					...
					send:		function ()
								{
									...
									else
									{
										...
										if ($('#ns1blankspaceMainDetails').html() != '')
										{
                                            ...
                                            oData.contactperson_mobile = $('#ns1blankspaceDetailsMobile').val();
											oData.registration_spacename = $('#ns1blankspaceDetailsBusiness').val();
                                            //oData.registration_verifycode = $('#ns1blankspaceDetailsVerifyCode').val();
										}
